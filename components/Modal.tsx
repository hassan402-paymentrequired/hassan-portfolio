...
const Modal = () => {
  return (
    <section className="absolute p-5 top-3 left-0 min-h-screen flex w-full flex-1 flex-col lg:items-center ">
      <div className="container relative mx-auto flex w-full flex-1 flex-col  max-w-[1550px] rounded-[24px] shadow-[0_0_40px_0_rgba(0,0,0,0.5)] bg-[#020407] z-10 p-2 border">
